...
// import resume from '../BF_Resume.pdf';
                        ...
                        <div className="col-md-8" id="contact-wrapper">
                            ...
                            <div id="contact-info">
                                ...
                                <div id="icons">
                                    ...
                                    <a href="../BF_Resume.pdf" target="_blank"><i className="fa fa-arrow-circle-down social-icons" aria-hidden="true"></i>View My Resume</a>
